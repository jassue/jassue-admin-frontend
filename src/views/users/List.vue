<template>
  <div class="app-container">
    <div class="filter-container">
      <el-row>
        <el-col :span="8">
          <el-button type="primary" @click="batchToggleStatus(0)">{{ $t('table.enable') }}</el-button>
          <el-button @click="batchToggleStatus(1)">{{ $t('table.disable') }}</el-button>
          <el-button v-if="checkPermission('ADMIN_DELETE')" type="danger" @click="batchDelete">{{ $t('table.delete') }}</el-button>
        </el-col>
        <el-col :span="16" style="text-align:right">
          <el-select v-model="query.status" style="width:100px" @change="handleFilter">
